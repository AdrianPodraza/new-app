  ...
  return (
    <Dialog>
      ...
      <DialogContent className='flex flex-col rounded-lg bg-white p-4'>
        <DialogHeader>
          <DialogTitle className='text-grey-900 text-[32px] font-bold'>Delete ‘Savings’?</DialogTitle>
          <DialogDescription className='text-[14px] text-gray-500'>
            Are you sure you want to delete this pot? This action cannot be reversed, and all the data inside it will be
            removed forever.
          </DialogDescription>
        </DialogHeader>
